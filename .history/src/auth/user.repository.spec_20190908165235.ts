...
const mockCredentialsDto = { username: 'TestUsername', password: 'TestPassword', salt: 'asdasd' };
describe('UserRepository', () => {
    ...
    describe('signUp', () => {
        ...
        it('trow a conflict exeption as username already exists', () => {
            save.mockRejectedValue({code: '23512305'});
    ...
    describe('validateUserPassword', () => {
        ...
        it('returns the username as validation is successful', async () => {
            ...
            user.validateUserPassword.mockResolvedValue(user);
            const result = await userRepository.validateUserPassword(mockCredentialsDto);
            expect(result).toEqual('TestUsername');
        });
        it('returns the null as user cannot be found', () => {});
        it('returns the null as password is invalid', () => {});
